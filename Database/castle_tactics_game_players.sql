...
CREATE TABLE `game_players` (
  ...
  `opponent_user_name` varchar(255) DEFAULT NULL,
  KEY `game_id` (`game_id`),
  KEY `user_name` (`user_name`),
  CONSTRAINT `game_players_ibfk_1` FOREIGN KEY (`game_id`) REFERENCES `game_details` (`game_id`),
  CONSTRAINT `game_players_ibfk_2` FOREIGN KEY (`user_name`) REFERENCES `user_details` (`user_name`)
